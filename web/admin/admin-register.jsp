...
<body id="bd" class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">

            <a href="all-admin-index.html"><b>人事</b>管理系统</a>
        ...
        <div class="register-box-body">
            ...
            <div class="row">
                <div class="col-xs-12 text-center" style="color: red">${register_error}</div>
            </div>
        </div>
        <!-- /.form-box -->
    </div>
